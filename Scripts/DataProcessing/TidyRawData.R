# =============================================================================
# Script Name:    TidyRawData.R
# Project:        Chapter1
# Author:         Ethan Heidtman
# Description:    Loads each piece of raw data, creates common columns, and writes
...
############################ Write Tidied Data #################################
  write.csv(CB2.2_Salinity, 'Data/Tidied/Processed/CB2.2_SalinityData.csv')
  write.csv(CCity_Tide, 'Data/Tidied/Processed/ChesapeakeCityTides.csv')
  write.csv(HdG_Tide, 'Data/Tidied/Processed/HavreDeGraceTides.csv')
  write.csv(CON_Obs, 'Data/Tidied/Processed/ConowingoDischarge.csv')
  write.csv(MAR_Obs, 'Data/Tidied/Processed/MariettaDischarge.csv')
  write.csv(DateTime, 'Data/Tidied/Processed/DateTime_1985-10-01_to_2024-08-31.csv')
  write.csv(DNR_Salinity, 'Data/Tidied/Processed/DNRSalinityData.csv')
  write.csv(ferc, 'Data/Tidied/Processed/FERCFlowRequirement.csv')
